...
INSERT INTO resources(
  ...
  ?1, ?2, ?3, ?4
) RETURNING id, entity_id, mining_time, results, required_fluid
`
...
SELECT id, entity_id, mining_time, results, required_fluid FROM resources
`
...
SELECT resources.id, entity_id, mining_time, results, required_fluid, entities.id, name, prototype_type, entity_order
FROM resources
LEFT JOIN entities
